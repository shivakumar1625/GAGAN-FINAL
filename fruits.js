    ...
    const products = [
        {
            ...
            para2:`Botanical Name: Mangifera indica<br>
             ...
             Plant Description: The mango tree is a large, spreading evergreen that can grow up to 35-40 meters tall. It has a dense canopy of green leaves and small, fragrant white flowers. The fruit is typically oval or round, with a smooth, leathery skin that can be yellow, orange, red, or green when ripe.<br>

            Soil Requirements: Mangoes thrive in well-drained, sandy loam to clay loam soils with a pH range of 5.5-7.5. They require fertile soil rich in organic matter and good drainage to prevent root rot.<br>
           ...
           varieties: {
            ...
            shipment: `Inspection: As per the buyer's requirement (e.g., SGS)<br>
            Packing: Standard in 5 Kg cartons or as per customer requirements<br>
             Mode of Payment: TT, LC <br>
             Delivery: Delivered to the loading port of choice within 15 days from the date of receipt of confirmed purchase order & advance payment.<br>
            Applicable Shipment Terms: FOB/CFR/CIF Inco Terms 2020, as needed by the customer.`,
        ...
        },
        {
            ...
            Family: Phyllanthaceae <br>
             Plant Description: Indian gooseberry, also known as Amla, is a small to medium-sized deciduous tree that grows up to 8-18 meters tall. It has a crooked trunk and spreading branches. <br>
             The leaves are simple, closely set along the branches, and are light green in color. The tree produces small, greenish-yellow flowers and round, smooth, fleshy fruit that is light green to yellowish in color.<br>
        ...
        },
        {
            ...
            Plant Description: Guava is a small evergreen tree or shrub that grows up to 3-10 meters tall. It has broad, dark green leaves and produces white flowers.<br>
             The fruit is round to oval-shaped, with a thin skin that can be green, yellow, or red. The flesh inside is white, pink, or red, and contains numerous small seeds.<br>
             Soil Requirements: Guavas grow best in well-drained, sandy loam to clay loam soils with a pH range of 5.5-7.5. They are tolerant of a wide range of soil types but prefer fertile, organic-rich soils.<br>
             Climate Requirements: Guavas thrive in tropical and subtropical climates with temperatures between 23-28°C. They require a warm climate with moderate rainfall and are sensitive to frost.<br>
        ...
        },
        {
            ...
            Family: Arecaceae <br>
             Plant Description: The coconut palm is a large, single-trunked palm that can grow up to 30 meters tall. It has a crown of large, feathered leaves, each 4-6 meters long.<br>
              The tree produces clusters of coconuts, which are large, oval-shaped fruits with a fibrous outer husk and a hard, woody shell surrounding the edible white flesh and coconut water inside.<br>
